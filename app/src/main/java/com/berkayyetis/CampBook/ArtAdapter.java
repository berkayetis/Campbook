...
import com.berkayyetis.CampBook.databinding.RecyclerRowBinding;
...
public class ArtAdapter extends RecyclerView.Adapter<ArtAdapter.ArtHolder> {
    ...
    public void onBindViewHolder(ArtAdapter.ArtHolder holder, int position) {
        ...
        //holder.binding.idTextView.setText(artArrayList.get(position).id.toString());
        holder.binding.nameTextView.setText(artArrayList.get(position).author);
        holder.binding.pageTextView.setText(artArrayList.get(position).page);
